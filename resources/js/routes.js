...
const routes = [
    ...
    },
    {
        ...
        children: [
            ...
            },
            {
                name: "profile",
                path: "/profile",
                component: require("./components/Admin/users/Profile.vue")
                    .default,
                meta: {
                    middleware: [permissionHome],
                },
    ...
    },
    {
        ...
        children: [
            ...
            },
            {
                name: "products",
                path: "products",
                component: require("./components/Admin/products/Product.vue")
                    .default,
                meta: {
                    middleware: [permissionHome],
                },
            },
            {
                name: "sliders",
                path: "sliders",
                component: require("./components/Admin/sliders/Slider.vue")
                    .default,
                meta: {
                    middleware: [permissionHome],
                },
            },
            {
                name: "customers",
                path: "customers",
                component: require("./components/Admin/customers/Customer.vue")
                    .default,
                meta: {
                    middleware: [permissionHome],
                },
            },
            {
                ...
                component: require("./components/Admin/upload/UploadFile.vue")
                    .default,
                meta: {
                    middleware: [permissionHome],
                },
            ...
            },
            {
                name: "getLink",
                path: "get-link",
                component: require("./components/Admin/anime/GetLink.vue")
                    .default,
                meta: {
                    middleware: [permissionHome],
                },
    ...
    },
    {
        name: "404",
        path: "*",
        component: require("./components/404NotFound.vue").default,
    },
];
